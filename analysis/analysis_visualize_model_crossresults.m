function analysis_visualize_model_crossresults(tesj_num, trsj_num, tropt, varargin)
...
figbasename = strrep(strrep(crtename, '_predict_rating_crosstest_', '_predict_rating_figure_'), '.mat', '');
