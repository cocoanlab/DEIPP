...
if doboot
    ...
    rng('default');
    [ci, names] = roc_boot(input_values, binary_outcome, thr, ROC.class_threshold, 0);
...
if doOutput
    ...
    if doboot
        ...
        fprintf('Nonparametric AUC:\t%3.2f CI(%3.2f-%3.2f)\tParametric d_a:\t%3.2f\t', ROC.AUC, ROC.AUC_ci, ROC.Gaussian_model.d_a);
    else
        fprintf('Threshold:\t%3.2f\tSens:\t%3.0f%%\tSpec:\t%3.0f%%\tPPV:\t%3.0f%%\t', ...
            ROC.class_threshold, 100*ROC.sensitivity, 100*ROC.specificity, 100*ROC.PPV);
